...
# TODO if NA, check the unroll/domain names lookup
...
gitlog_networks_feb <- gitlog_networks_org %>% 
  ...
  mutate(author_best_email = ifelse(any(author_company_type %in% c("public", "education", "private")),
           author_email[which(author_company_type %in% c("public", "education", "private"))],
...
ggplot(author_company_type_summary %>% filter(!is.na(author_best_company_type)), 
...
ggplot(author_company_summary_has_commit %>% filter(! is.na(author_best_company)),
